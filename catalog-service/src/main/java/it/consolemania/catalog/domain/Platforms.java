...
public final class Platforms {
    ...
    public static final PlatformRequest NEO_GEO_AES_REQUEST = PlatformRequestBuilder.builder()
            ...
            .type(PlatformType.HomeVideoGameConsole)
            .media(Media.RomCartridge)
    ...
    public static final Platform NEO_GEO_AES = fromRequest(UUID.randomUUID(), NEO_GEO_AES_REQUEST, 1);

    private static Platform fromRequest(UUID platformId, PlatformRequest platform, Integer version) {
